...
public class ExcelUtil {
	...
	public static int exportExcel(List<ExamEtudiant> examEtudiants, Exam exam) throws IOException {
		...
		FileOutputStream out = new FileOutputStream(new File("C:\\Users\\HPELITEBOOK\\Documents\\excel\\Etudiants "+ exam.getFiliere().getLibelle()+ " " +exam.getReference() + new Date().getTime()+ ".xlsx"));
		//Create sheet
